...
export default function HomeText() {
    ...
    return (
            <main>
                <Grid>
                    <Typography style={{marginBottom:'20px', marginTop:'5%', color:'#4e4f52', textAlign:'center', paddingTop:'5%', fontFamily:'Helvetica', fontWeight:'bold'}} variant='h4'> Find Your College Match</Typography>
