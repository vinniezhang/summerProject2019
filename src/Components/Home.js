...
export default function HomeText() {
    ...
    return (
            <main>
                ...
                <Typography style={{marginBottom:'20px', marginTop:'3%', color:'#4e4f52', textAlign:'center', paddingTop:'5%', fontFamily:'Helvetica', fontWeight:'bold'}} variant='h4'> Find Your College Match</Typography>
